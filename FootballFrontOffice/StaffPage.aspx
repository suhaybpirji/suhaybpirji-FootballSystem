...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnApply" runat="server" style="z-index: 1; left: 54px; top: 449px; position: absolute; width: 76px;" Text="Apply" OnClick="btnApply_Click" />
        <asp:Button ID="btnDelete" runat="server" style="z-index: 1; left: 176px; top: 576px; position: absolute; height: 36px; width: 77px;" Text="Delete" OnClick="btnDelete_Click" />
        <asp:Button ID="btnAdd" runat="server" style="z-index: 1; left: 41px; top: 581px; position: absolute; height: 32px; width: 48px;" Text="Add" OnClick="btnAdd_Click" />
        <asp:Button ID="btnEdit" runat="server" style="z-index: 1; left: 111px; top: 579px; position: absolute; height: 32px; width: 50px;" Text="Edit" OnClick="btnEdit_Click" />
